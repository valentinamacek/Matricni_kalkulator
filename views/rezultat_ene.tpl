%rebase('base.tpl')
    ...
    <div class="d-flex flex-row">
       <div class="p-4"> 
        ...
        <div class="p-2 align-self-center"><a href="/operacije-ena/"> Izberi drugo matriko </a></div>
    ...
    <div class="row">
        ...
        <p>
         <div class="btn-group mr-2" role="group" aria-label="First group">
          % for operacija in operacije:
            <button type="button" data-bs-toggle="collapse" data-bs-target="#{{ operacija }}_rezultat" 
            aria-expanded="false" aria-controls="{{ operacija }}_rezultat" class="btn btn-outline-primary" >{{operacija.capitalize()}}</button>
          %end
         </div>
        ...
        %else:
          ...
          <div class="input-group px-2">
            ...
            <button type="button" class="btn btn-outline-primary btn-md " data-bs-toggle="collapse" data-bs-target="#potenciraj_rezultat" 
            aria-controls="potenciraj_rezultat" > Potenciraj </button>
          </div>
          %else:
          <div class="input-group px-2">
        ...
        %else:
           %if skalar!='':
            ...
            <button type="button" class="btn btn-outline-primary btn-md" data-bs-toggle="collapse" data-bs-target="#mnozenje_s_skalar_rezultat" 
            aria-controls="mnozenje_s_skalar_rezultat"> Pomnoži </button>
            </div>
           %else:
            <div class="input-group">
    ...
    <div class="container">
        ...
        <div class="row">
         <div class="col">
            <div class="collapse multi-collapse" id="determinanta_rezultat">
                <div class="card card-body">
        ...
        <div class="row">
         <div class="col">
            <div class="collapse show multi-collapse" id="potenciraj_rezultat">
                ...
                %else:
                    <div class="row justify-content-sm-center gx-3">
                        <div class="col-sm-auto">
                        <table class="matrika">                                   
                        % for vrstica in  matrika_izbrana.spremeni_obliko_matrike():
                            <tr>
